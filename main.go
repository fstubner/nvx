...
func main() {
	...
	case "cleanup":
		...
		// than the whole sweep being abandoned because any session is running.
		// The automatic sweep after every contained command does the same work a
		// few profiles at a time.
